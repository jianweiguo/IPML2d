...
def WriterXMLFiles(filename, path, box_list, label_list, w, h, d):
    ...
    databasename.appendChild(doc.createTextNode("IPML2d"))
...
if __name__ == "__main__":
    txt_path = '/home/jianwei/projects/objectDetection/R2CNN_Faster-RCNN_Tensorflow/data/io/VOCdevkit/VOCdevkit_train/txts/'
    xml_path = '/home/jianwei/projects/objectDetection/R2CNN_Faster-RCNN_Tensorflow/data/io/VOCdevkit/VOCdevkit_train/Annotation/'
    img_path = '/home/jianwei/projects/objectDetection/R2CNN_Faster-RCNN_Tensorflow/data/io/VOCdevkit/VOCdevkit_train/JPEGImages/'
